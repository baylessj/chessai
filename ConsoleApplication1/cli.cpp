...
/**
* @brief Executes the commands parsed by the readCommands() function
*
* @param buf
*        The string designating which command to run
*
* @return True when the command executes properly
*/
...
/**
* @brief Displays info about the current game
*/
void CLI::info()
{
...
/**
* @brief Allows for the modification of the board setup for a new game
*/
void CLI::setup()
{
...
/**
*
* The FEN functions are all direct implementations of the FEN initialization code written for the Winglet Chess Engine.
*
*/

/**
* @brief Interprets a Forsyth-Edwards Notation setup for the board
*
* @param filename
*        FEN file to open
* @param number
*        The position number to be initialized from the FEN file
*
* @return True when the FEN reading properly executes
*/
...
/**
* @brief Sets up the board according to the FEN strings found in readFEN()
*
* @param fen
*        The FEN string designating the position setup
* @param fencolor
*        The color of the next move to be played in the game being initialized
* @param fencastling
*        Designates if the FEN position being evaluated represents a castle
* @param fenenpassant
*        Designates if the FEN position being evaluated represents an en passant capture
* @param fenhalfmoveclock
*        Fifty Move number
* @param fenfullmovenumber
